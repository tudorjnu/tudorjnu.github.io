...
## [Check boot mode](https://wiki.archlinux.org/title/installation_guide#Verify_the_boot_mode)
...
I am going for the following subvolume layout, inspired by [this](https://github.com/classy-giraffe/easy-arch?tab=readme-ov-file) and [this](https://wiki.archlinux.org/title/Snapper#Suggested_filesystem_layout). I am planning to use [snapper](https://wiki.archlinux.org/title/Snapper) as my snapshot manager. However, I am going to have my root directly at "@". Due to the nature of _BTRFS_,
this will impact the other subvolumes. In other words, rollbacks in root will not rollback its subvolumes. See more info here
...
pacstrap -K /mnt base base-devel \
                 ...
                 neovim git btrfs-progs intel-ucode
```
...
2. Regenerate the images (needs to be done for every kernel)
